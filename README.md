...
## Dataset
Dataset yang digunakan pada program ini adalah dataset **Rock Paper Scissors Images** yang diperoleh dari Kaggle.
Dataset dapat diunduh melalui link berikut:
:contentReference[oaicite:0]{index=0}
Dataset yang digunakan disimpan dalam folder `rockpaperscissors`yang terdapat:
- Rock
- Paper
- Scissors

Setelah dataset diunduh dan diekstrak, struktur folder harus seperti berikut:
```text
rockpaperscissors/
├── paper/
├── rock/
